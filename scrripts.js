/**
 * script.js
 * Nedu's Gadgets — Stage 4: Full interactive prototype
 *
 * Features:
...
(() => {
  ...
  /* ---------------------------
     ...
     --------------------------- */
  const STORE_NAME = "Nedu's Gadgets";
  const WA_NUMBER = '2348137471522';
  const LOCALSTORAGE_CART_KEY = 'nedus_gadgets_cart_v1';
